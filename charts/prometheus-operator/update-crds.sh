...
curl -s "${ROOT_URL}monitoring.coreos.com_prometheusagents.yaml" -o crds/crd-prometheusagents.yaml
curl -s "${ROOT_URL}monitoring.coreos.com_scrapeconfigs.yaml" -o crds/crd-prometheusagents.yaml
